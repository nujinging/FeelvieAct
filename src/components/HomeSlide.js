...
export default function HomeSlide(props) {
    ...
    return (
        <Swiper pagination={pagination} navigation={true} loop={true} autoplay={{ delay: 2500, disableOnInteraction: false, }} modules={[ Autoplay, Pagination, Navigation]} className="home_banner">
            {slideList.map(item => (
